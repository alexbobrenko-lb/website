...
var dataScriptHost =
  "https://85a977bda9a57d3a66a93bc7e3bd024d.s3.us-east-2.amazonaws.com";
...
var LB_LOCAL_STORAGE_KEY = "lb-cookie-consent";
var LB_LOCAL_STORAGE_PREFERENCES_KEY = "lb-preferences";
var LB_LOCAL_STORAGE_SCRIPT_SETTINGS_KEY = "lb-script-settings";
var LB_GCM_INITIAL_CONSENTS = {
 ...
 * }
 */
var lbCookieConsentRoot =
  document.getElementById("lb-cookie-consent") ||
  document.querySelector('[src*="amazonaws.com/cookie_consent_"]');
var lbCookieConsent = {
  ...
  getHostingBaseUrl: () => {
    return `${dataScriptHost}/cookie_consent_${ccVersion}/${domainId}`;
  },
};
...
var getLbEssentialsWhiteList = () => {
  return [
    ...
    getLbMainDomain(),
    "." + getLbMainDomain(),
    ...(lbCookieConsent.isGcmOn || lbCookieConsent.isPrefCenterOnly
...
(function () {
  // Init consent mode defaults for Google Consent Mode if GCM is on or script is loaded via GTM
  // lbCookieConsent.initGtagDefaults();
  ...
  !(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
        ...
        : e(
            ((t =
              "undefined" != typeof globalThis ? globalThis : t || self).yett =
              {}),
          );
  })(this, function (t) {
    "use strict";
